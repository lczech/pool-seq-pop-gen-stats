...
\fbox{%
  \parbox{48em}{
        \large
        \textbf{Version: 2023-04-12}
        \\ \\
        See \url{https://github.com/lczech/pool-seq-pop-gen-stats} \\
...
The effct of those bugs is shown in \figref{fig:bug-exam}. In short, we observed an overestimation of Tajima's D in the range 2.8 to 3.5 times when using the default settings of \toolname{PoPoolation}.
